...
SAR_chance_bandits = 70;
SAR_chance_soldiers = 60;
SAR_chance_survivors = 60;
...
SAR_soldier_sold_list = ["Soldier1_DZ","Camo1_DZ","US_Soldier_EP1"]; // the potential classes of the riflemen of a soldier group

// bandit AI
SAR_leader_band_list = ["Worker1"]; // the potential classes of the leader of a bandit group
SAR_sniper_band_list = ["Villager1"]; // the potential classes of the snipers of a bandit group
SAR_soldier_band_list = ["TK_CIV_Takistani05_EP1","TK_CIV_Takistani01_EP1","TK_INS_Soldier_EP1","CZ_Soldier_DES_EP1"]; // the potential classes of the bandit of a soldier group
...
SAR_soldier_surv_list = ["Survivor2_DZ","SurvivorW2_DZ","Soldier_Crew_PMC","Citizen3"]; // the potential classes of the riflemen of a soldier group
...
SAR_leader_weapon_list = ["M4A1","M4A3_CCO_EP1","AK_47_M","M242BC"];
...
SAR_leader_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["PipeBomb",50]];
SAR_leader_tools =  [["ItemMap",50],["ItemCompass",50],["Binocular_Vector",50],["NVGoggles",50],["ItemRadio",100],["ItemGPS,70"]];

//potential weapon list for riflemen
SAR_rifleman_weapon_list = ["M16A2","bizon_silenced","AK_74","FN_FAL","M1014","AK_74_GL_kobra"];
...
SAR_rifleman_items = [["ItemSodaCoke",75],["FoodCanBakedBeans",60],["PipeBomb",30]];
SAR_rifleman_tools = [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",10],["NVGoggles",5],["ItemGPS,20"]];

//potential weapon list for snipers
SAR_sniper_weapon_list = ["M4A1_Aim","SVD_CAMO","G36K","BAF_AS50_scoped","DMR"];
...
SAR_sniper_tools = [["ItemMap",50],["ItemCompass",30],["Binocular_Vector",50],["NVGoggles",50]];
