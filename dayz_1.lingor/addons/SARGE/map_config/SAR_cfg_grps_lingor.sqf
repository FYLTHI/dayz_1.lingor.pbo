...
_this = createMarker ["SAR_patrol_prison", [6805.1294,5799.4155]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [1500, 1050];
SSAR_patrol_prison = _this;
...
SAR_patrol_maruko_airport = _this;
 
_this = createMarker ["SAR_patrol_fob_eddie", [6775.3892,5798.7905]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [1500, 1500];
SAR_patrol_fob_eddie = _this;
 
_this = createMarker ["SAR_patrol_calamar", [6747.1025,5756.7412]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [2000, 2000];
SAR_patrol_calamar = _this;
 
_this = createMarker ["SAR_patrol_mainland", [6746.1719,5782.811]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [4500, 4500];
SAR_patrol_mainland = _this;
 
_this = createMarker ["SAR_Survivor_Camp", [1273.59,2285.12,0.001]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [4500, 4500];
SAR_Survivor_Camp = _this;
 
_this = createMarker ["SAR_Desert_Base", [1184.63,2668.26,0.001]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [4500, 4500];
SAR_Desert_Base = _this;
 
 _this = createMarker ["SAR_Bandit_Camp", [8113.03,6722.69,0.001]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [4500, 4500];
SAR_Bandit_Camp = _this;
...
_this = createMarker ["SAR_Burnt_House", [6601.04,6551.14,0.571]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [4500, 4500];
SAR_Burnt_House = _this;
 
_this = createMarker ["SAR_Bandit_Outpost", [6410.79,5595.92,0.001]];
_this setMarkerShape "RECTANGLE";
_this setMarkeralpha 0;
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
...
[SAR_Desert_Base,1,1,10,"patrol",false] call SAR_AI;
 
[SAR_El_Presedente,1,2,10,"fortify",true] call SAR_AI;
 
[SAR_Survivor_Camp,2,3,10,"patrol",false] call SAR_AI;
 
[SAR_Burnt_House,2,1,6,"fortify",true] call SAR_AI;
 
[SAR_Bandit_Camp,3,2,10,"patrol",false] call SAR_AI;
 
[SAR_Bandit_Outpost,3,1,10,"patrol",true] call SAR_AI;
